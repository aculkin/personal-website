export const languages = [
  {
    ...
    proficiency: 3,
    description:
      'I’ve always been a proponent of Javascript as a front end and back end language, especially when it comes to web based projects. The work required to get a new project up and running is minimal compared to other languages so it makes sense in the fast paced world of startups. A strictly typed language would be good for larger companies willing to spend more time on development, but in a startup speed, proof of concept, and time to market are all more important than building a perfect first product. In my experience managing younger teams, it is much easier to have a single language that we can use on both the front end and the back end.',
